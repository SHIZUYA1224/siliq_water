...
- **プリセット 11 種** — 湖 / 海 / 外洋 (スペクトル) / 川 / 雨 / さざ波 / トゥーン / 溶岩 / プール / サイバー / 室内ブループール
...
水面マップスタジオでは `目的から始める` から、綺麗な海 / 透明プール / 室内ブループール / 血の海 / 液体金属の推奨生成設定を一括適用できます。
...
綺麗な海、透明プール、室内ブループール、血の海、液体金属のような用途が決まっている場合は、
...
薄すぎる場合は水面マップスタジオの **不透明度** を 0.5 以上に上げるか、用途別の `美しい海` / `透明プール` / `室内ブループール` を使ってください。
