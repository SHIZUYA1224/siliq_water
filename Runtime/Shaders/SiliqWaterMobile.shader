...
Shader "Siliq/Water Mobile (Quest)"
{
    Properties
    {
        ...
        _DisplacementSpeed ("高さの速度", Range(0, 1)) = 0.00018
        ...
        _Scroll1 ("レイヤー1 スクロール (XY)", Vector) = (0.00016, 0.00006, 0, 0)
        _Scroll2 ("レイヤー2 スクロール (XY)", Vector) = (-0.00005, 0.00011, 0, 0)
        ...
        _CausticsSpeed ("水底の光の速度", Range(0, 0.25)) = 0.00004
