...
namespace Siliq.Water.Editor
{
    ...
    public static class WaterPackQuickApply
    {
        ...
        static readonly MotionPreset CalmMotion = new MotionPreset(35f, 0.014f, 1.35f, 1.35f);
        static readonly MotionPreset RippleMotion = new MotionPreset(0f, 0f, 0.55f, 1.15f);
        static readonly MotionPreset StreamMotion = new MotionPreset(0f, 0.030f, 1.45f, 1.8f);
        static readonly MotionPreset PoolMotion = new MotionPreset(50f, 0.009f, 0.55f, 1.08f);
        static readonly MotionPreset CyberMotion = new MotionPreset(18f, 0.014f, 0.78f, 1.24f);
        ...
        static readonly LookPreset ClearSeaLook = new LookPreset
        {
            ...
            sourceGuid = CalmGuid,
            sourceLabel = "Calm",
            motion = new MotionPreset(22f, 0.014f, 0.92f, 1.45f),
            transparent = true,
            opacity = 0.46f,
        ...
        static readonly LookPreset ClearPoolLook = new LookPreset
        {
            ...
            sourceGuid = PoolGuid,
            sourceLabel = "Pool",
            motion = new MotionPreset(50f, 0.008f, 0.38f, 1.0f),
            transparent = true,
            opacity = 0.34f,
        ...
        static readonly LookPreset IndoorBluePoolLook = new LookPreset
        {
            ...
            sourceGuid = CalmGuid,
            sourceLabel = "Calm",
            motion = new MotionPreset(18f, 0.007f, 0.46f, 0.82f),
            transparent = true,
            opacity = 0.38f,
        ...
        static readonly LookPreset FlagshipCrystalLook = new LookPreset
        {
            ...
            motion = new MotionPreset(26f, 0.009f, 0.58f, 1.18f),
            transparent = true,
            opacity = 0.52f,
        ...
        static readonly LookPreset CrystalLagoonLook = new LookPreset
        {
            ...
            motion = new MotionPreset(20f, 0.006f, 0.42f, 0.92f),
            transparent = true,
            opacity = 0.40f,
        ...
        static readonly LookPreset BloodSeaLook = new LookPreset
        {
            ...
            sourceLabel = "Stream",
            motion = new MotionPreset(6f, 0.010f, 0.82f, 1.18f),
            transparent = true,
            opacity = 0.68f,
        ...
        static readonly LookPreset LiquidMetalLook = new LookPreset
        {
            ...
            sourceLabel = "Cyber",
            motion = new MotionPreset(18f, 0.012f, 0.72f, 1.38f),
            transparent = false,
            opacity = 1f,
        ...
        static void SetupSiliqMobileTransparent(Material mat, float opacity)
        {
            ...
            if (mat.HasProperty("_DisplacementSpeed")) mat.SetFloat("_DisplacementSpeed", 0.016f);
            ...
            if (mat.HasProperty("_CausticsSpeed")) mat.SetFloat("_CausticsSpeed", 0.003f);
        ...
        static void SetupExpandingRippleMaterial(Material mat)
        {
            ...
            if (mat.HasProperty("_DisplacementSpeed")) mat.SetFloat("_DisplacementSpeed", 0.012f);
            if (mat.HasProperty("_HeightMapInfluence")) mat.SetFloat("_HeightMapInfluence", 0f);
